...
public function set_sales_order_header($CustomerID,$Subtotal,$TaxID,$Net_due,$user,$nopo,$pago,$licitacion,$observaciones,$entrega,$ordertax,$fecha_entrega,$lugDesp,$salesrep){
$this->SESSION();

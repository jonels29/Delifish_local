...
$.when(ccost(), phase(), jobs() ).done(function(cost, phase, jobs){ 
...
while(i <= cantLineas){
			...
			if(chk==1){ 
					...
					reglon = '<td width="25%" >'+
						 /*'<div class="select-editable">'+*/
						    '<select id="sel'+i+'" class="selectItems col-lg-12" onchange="SetDesc(this.value,'+i+')">'+
						        '<option value=""></option>'
						         +listitem+
						    '</select>'+
		  ...
		  '<td width="30%" class="rowtable_req" onkeyup="checkChar('+descid+');" contenteditable id="desc'+i+'"  ></td>'+
			...
			'<td width="10%" class="rowtable_req numb" contenteditable><select class="selectItems col-lg-12" id="JOB'+i+'" ><option  value="-" selected>-</option>'+JOBS+'</select></td>'+
			'<td width="10%" class="rowtable_req numb" contenteditable><select class="selectItems col-lg-12" id="PHS'+i+'" ><option  value="-" selected>-</option>'+PHASES+'</select></td>'+
			'<td width="10%" class="rowtable_req numb" contenteditable><select class="selectItems col-lg-12" id="CCO'+i+'" ><option  value="-" selected>-</option>'+CCOST+'</select></td>'+
			'</tr>' ;

			 i++

			 $('#table_req').append(line_table_req); 
